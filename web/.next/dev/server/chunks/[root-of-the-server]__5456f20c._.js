...
async function GET() {
    try {
        ...
        }).from(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["styles"]);
        ...
        const result = Array.from(counts.entries()).map(([tag, count])=>({
                tag,
                count
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5456f20c._.js.map